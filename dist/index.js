...
;// CONCATENATED MODULE: ./lib/webhook.js
...
const EMBED_KEYS = [TITLE, DESCRIPTION, TIMESTAMP, COLOR, webhook_URL];
const EMBED_AUTHOR_KEYS = [NAME, webhook_URL, ICON_URL];
const EMBED_FOOTER_KEYS = [TEXT, ICON_URL];
const EMBED_IMAGE_KEYS = [webhook_URL];
const EMBED_THUMBNAIL_KEYS = [webhook_URL];
const DESCRIPTION_LIMIT = 4096;
function createPayload() {
    // If raw-data provided, load the file and ignore the other parameters
    const rawData = core.getInput(RAW_DATA);
    if (rawData.length > 0) {
        return JSON.parse((0,external_fs_.readFileSync)(rawData, 'utf-8'));
    }
...
var __webpack_exports__executeWebhook = __webpack_exports__.o;
export { __webpack_exports__executeWebhook as executeWebhook };
